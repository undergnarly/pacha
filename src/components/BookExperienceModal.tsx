                ...
                {experiences.map((exp) => (
                  ...
                  >
                    <div className="relative aspect-[16/9] overflow-hidden bg-black">
                      ...
                      />
                      <div className="absolute right-2 top-2 rounded-full bg-black/60 px-3 py-1 text-xs font-semibold backdrop-blur-sm">
                        {exp.price}
                      </div>
                    </div>
                    <div className="flex flex-1 flex-col p-4">
                      <h3 className="mb-1 font-[family-name:var(--font-golos)] text-base font-semibold">
                        {exp.title}
                      </h3>
                      <p className="mb-3 line-clamp-2 flex-1 text-xs text-white/60">
                        {exp.subtitle}
                      </p>
                      <div className="flex flex-col gap-2">
                        ...
                        {exp.secondary && (
                          <button
                            ...
                            className="flex items-center justify-center gap-2 rounded-full border border-[#25D366]/60 bg-[#25D366]/10 px-4 py-2.5 text-xs font-semibold uppercase tracking-widest text-[#25D366] transition-colors hover:bg-[#25D366]/20"
                          >
